  ...
  return (
    <div className="demo-container">
      <div className="demo-content">
        ...
        <p className="demo-subtitle"> Visualisation de la trajectoire SNBC des collectivités - région Auvergne-Rhône-Alpes</p>
            ...
            <div className="demo-control-group">
              ...
              >
                ...
                {calculatedData.sectors.map((secteur: any) => (
                  <option key={secteur.name} value={secteur.name}>{secteur.name}</option>
                ))}
              </select>
            </div>
            <div className="demo-control-group">
                ...
                {externalSecteur === ''
                  ? calculatedData.sectors.flatMap((secteur: any) =>
                      secteur.levers.map((levier: any) => (
                        <option key={secteur.name + '-' + levier.name} value={levier.name}>{levier.name} ({secteur.name})</option>
                      ))
                    )
                  : (() => {
                      const secteur = calculatedData.sectors.find((s: any) => s.name === externalSecteur);
                      if (!secteur) return null;
                      return secteur.levers.map((levier: any) => (
                        <option key={levier.name} value={levier.name}>{levier.name}</option>
                      ));
                    })()
                }
              </select>
        ...
        <div className="demo-status">
          ...
          {(externalSecteur || externalLevier) ? (
            ...
            <span className="demo-status-empty">
              Aucune sélection
            </span>
          )}
        </div>
